...
EXPLIST = [ \
  # {"name":"etkf_non_clim",  "rho":1.05, "nmem":10, \
  #       "method":"etkf", "couple":"none", "bc":"climatology"}, \
  {"name":"etkf_non_3mem",  "rho":1.05, "nmem":3, \
        "method":"etkf", "couple":"none", "bc":"persistent"}, \
  {"name":"etkf_weak_3mem",  "rho":1.05, "nmem":3, \
        "method":"etkf", "couple":"weak"}, \
  {"name":"etkf_strong_3mem",  "rho":1.05, "nmem":3, \
        "method":"etkf", "couple":"strong"}, \
  {"name":"etkf_non_4mem",  "rho":1.05, "nmem":4, \
        "method":"etkf", "couple":"none", "bc":"persistent"}, \
  {"name":"etkf_weak_4mem",  "rho":1.05, "nmem":4, \
        "method":"etkf", "couple":"weak"}, \
  {"name":"etkf_strong_4mem",  "rho":1.05, "nmem":4, \
        "method":"etkf", "couple":"strong"}, \
  {"name":"etkf_non_6mem",  "rho":1.05, "nmem":6, \
        "method":"etkf", "couple":"none", "bc":"persistent"}, \
  {"name":"etkf_weak_6mem",  "rho":1.05, "nmem":6, \
        "method":"etkf", "couple":"weak"}, \
  {"name":"etkf_strong_6mem",  "rho":1.05, "nmem":6, \
        "method":"etkf", "couple":"strong"}, \
  {"name":"etkf_non_10mem",  "rho":1.05, "nmem":10, \
        "method":"etkf", "couple":"none", "bc":"persistent"}, \
  {"name":"etkf_weak_10mem",  "rho":1.05, "nmem":10, \
        "method":"etkf", "couple":"weak"}, \
  {"name":"etkf_strong_10mem",  "rho":1.05, "nmem":10, \
        "method":"etkf", "couple":"strong"} \
  # # {"name":"tdvar_non_clim", \
